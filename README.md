...
So it's possible to get a basic sensor for round about 60€ (ESP8266 & BME280). If you can get the functionality (+ air pressure) as the [Everything Presence One](https://shop.everythingsmart.io/en-de/collections/everything-presence-one)
for round about 64€ (ESP32 & BME280). And the full package (ESP32 & BME680) with an additional air quality sensor for round about 70€.
