...
<a href="https://aiosense.readthedocs.io/en/latest/" target="_blank">
<img src="https://readthedocs.org/projects/aiosense/badge/?version=latest">
</a>


> Please wait for the final release of v2.0! v1.0 has some problems...

## Description

Based on the idea of
the [Presence One](https://shop.everythingsmart.io/en-de/products/everything-presence-one-kit?variant=41708846022853) I
made my own,
...
So it's possible to get a basic sensor for round about 60€ (ESP8266 & BME280). If you can get the functionality (+ air
pressure) as the [Everything Presence One](https://shop.everythingsmart.io/en-de/collections/everything-presence-one)
for round about 64€ (ESP32 & BME280). And the full package (ESP32 & BME680) with an additional air quality sensor for
round about 70€.
...
> ¹ You have to choose either the BME280 or the BME680 or neither. It's not possible to use both sensors.
>
> ² You have to choose either the ESP8266 or the ESP32. There is no need for the ESP32, but bluetooth.
>
> ³ Affiliate link
